...
typedef enum eLoRaMacRegion_t
{
	...
	/*!
	 * American Tower Brazil band on 915MHz
	 * 8 canais iniciais: começando em 915.2MHz,
	 * com incrementos de 200Hz, até 916.6MHz para uplinks,
	 * e os 8 finais para downlinks, com início em 923.3MHz e incrementos de 500Hz
	 * Rx1 = 5s e Rx2 = 6s
	 * Não indicado o uso dos Data Rates 0 e 1 (SFs 11 e 12, respectivamente)
	 */
	LORAMAC_REGION_ATCBR915,
}LoRaMacRegion_t;
