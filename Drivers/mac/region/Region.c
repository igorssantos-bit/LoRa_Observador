...
#ifdef REGION_ATCBR915
#include "RegionATCBR915.h"
#define ATCBR915_CASE                                 case LORAMAC_REGION_ATCBR915:
#define ATCBR915_IS_ACTIVE( )                         ATCBR915_CASE { return true; }
#define ATCBR915_GET_PHY_PARAM( )                     ATCBR915_CASE { return RegionATCBR915GetPhyParam( getPhy ); }
#define ATCBR915_SET_BAND_TX_DONE( )                  ATCBR915_CASE { RegionATCBR915SetBandTxDone( txDone ); break; }
#define ATCBR915_INIT_DEFAULTS( )                     ATCBR915_CASE { RegionATCBR915InitDefaults( params ); break; }
#define ATCBR915_GET_NVM_CTX( )                       ATCBR915_CASE { return RegionATCBR915GetNvmCtx( params ); }
#define ATCBR915_VERIFY( )                            ATCBR915_CASE { return RegionATCBR915Verify( verify, phyAttribute ); }
#define ATCBR915_APPLY_CF_LIST( )                     ATCBR915_CASE { RegionATCBR915ApplyCFList( applyCFList ); break; }
#define ATCBR915_CHAN_MASK_SET( )                     ATCBR915_CASE { return RegionATCBR915ChanMaskSet( chanMaskSet ); }
#define ATCBR915_COMPUTE_RX_WINDOW_PARAMETERS( )      ATCBR915_CASE { RegionATCBR915ComputeRxWindowParameters( datarate, minRxSymbols, rxError, rxConfigParams ); break; }
#define ATCBR915_RX_CONFIG( )                         ATCBR915_CASE { return RegionATCBR915RxConfig( rxConfig, datarate ); }
#define ATCBR915_TX_CONFIG( )                         ATCBR915_CASE { return RegionATCBR915TxConfig( txConfig, txPower, txTimeOnAir ); }
#define ATCBR915_LINK_ADR_REQ( )                      ATCBR915_CASE { return RegionATCBR915LinkAdrReq( linkAdrReq, drOut, txPowOut, nbRepOut, nbBytesParsed ); }
#define ATCBR915_RX_PARAM_SETUP_REQ( )                ATCBR915_CASE { return RegionATCBR915RxParamSetupReq( rxParamSetupReq ); }
#define ATCBR915_NEW_CHANNEL_REQ( )                   ATCBR915_CASE { return RegionATCBR915NewChannelReq( newChannelReq ); }
#define ATCBR915_TX_PARAM_SETUP_REQ( )                ATCBR915_CASE { return RegionATCBR915TxParamSetupReq( txParamSetupReq ); }
#define ATCBR915_DL_CHANNEL_REQ( )                    ATCBR915_CASE { return RegionATCBR915DlChannelReq( dlChannelReq ); }
#define ATCBR915_ALTERNATE_DR( )                      ATCBR915_CASE { return RegionATCBR915AlternateDr( currentDr, type ); }
#define ATCBR915_CALC_BACKOFF( )                      ATCBR915_CASE { RegionATCBR915CalcBackOff( calcBackOff ); break; }
#define ATCBR915_NEXT_CHANNEL( )                      ATCBR915_CASE { return RegionATCBR915NextChannel( nextChanParams, channel, time, aggregatedTimeOff ); }
#define ATCBR915_CHANNEL_ADD( )                       ATCBR915_CASE { return RegionATCBR915ChannelAdd( channelAdd ); }
#define ATCBR915_CHANNEL_REMOVE( )                    ATCBR915_CASE { return RegionATCBR915ChannelsRemove( channelRemove ); }
#define ATCBR915_SET_CONTINUOUS_WAVE( )               ATCBR915_CASE { RegionATCBR915SetContinuousWave( continuousWave ); break; }
#define ATCBR915_APPLY_DR_OFFSET( )                   ATCBR915_CASE { return RegionATCBR915ApplyDrOffset( downlinkDwellTime, dr, drOffset ); }
#define ATCBR915_RX_BEACON_SETUP( )                   ATCBR915_CASE { RegionATCBR915RxBeaconSetup( rxBeaconSetup, outDr ); break; }
#else
#define ATCBR915_IS_ACTIVE( )
#define ATCBR915_GET_PHY_PARAM( )
#define ATCBR915_SET_BAND_TX_DONE( )
#define ATCBR915_INIT_DEFAULTS( )
#define ATCBR915_GET_NVM_CTX( )
#define ATCBR915_VERIFY( )
#define ATCBR915_APPLY_CF_LIST( )
#define ATCBR915_CHAN_MASK_SET( )
#define ATCBR915_COMPUTE_RX_WINDOW_PARAMETERS( )
#define ATCBR915_RX_CONFIG( )
#define ATCBR915_TX_CONFIG( )
#define ATCBR915_LINK_ADR_REQ( )
#define ATCBR915_RX_PARAM_SETUP_REQ( )
#define ATCBR915_NEW_CHANNEL_REQ( )
#define ATCBR915_TX_PARAM_SETUP_REQ( )
#define ATCBR915_DL_CHANNEL_REQ( )
#define ATCBR915_ALTERNATE_DR( )
#define ATCBR915_CALC_BACKOFF( )
#define ATCBR915_NEXT_CHANNEL( )
#define ATCBR915_CHANNEL_ADD( )
#define ATCBR915_CHANNEL_REMOVE( )
#define ATCBR915_SET_CONTINUOUS_WAVE( )
#define ATCBR915_APPLY_DR_OFFSET( )
#define ATCBR915_RX_BEACON_SETUP( )
#endif
...
void RegionComputeRxWindowParameters( LoRaMacRegion_t region, int8_t datarate, uint8_t minRxSymbols, uint32_t rxError, RxConfigParams_t *rxConfigParams )
{
    switch( region )
    {
        ...
        ATCBR915_COMPUTE_RX_WINDOW_PARAMETERS( );
        default:
        {
            break;
        }
