/*!
 * \file      RegionATCBR915.h
 *
 * \brief     Region definition for ATCBR915
 *
 ...
 *
 * \defgroup  REGIONATCBR915 Region ATCBR915
 *            Implementation according to LoRaWAN Specification v1.0.2.
 * \{
 */
#ifndef __REGION_ATCBR915_H__
#define __REGION_ATCBR915_H__
 ...
 */
#define ATCBR915_MAX_NB_CHANNELS                       72
//#define ATCBR915_MAX_NB_CHANNELS                       32
 ...
 */
#define ATCBR915_TX_MAX_DATARATE                       DR_6

/*!
 * Minimal datarate that can be used by the node
 */
#define ATCBR915_RX_MIN_DATARATE                       DR_8

/*!
 * Maximal datarate that can be used by the node
 */
#define ATCBR915_RX_MAX_DATARATE                       DR_13
 ...
 */
#define ATCBR915_MIN_RX1_DR_OFFSET                     0

/*!
 * Maximal Rx1 receive datarate offset
 */
#define ATCBR915_MAX_RX1_DR_OFFSET                     6

/*!
 * Default Rx1 receive datarate offset
 */
#define ATCBR915_DEFAULT_RX1_DR_OFFSET                 0

/*!
 * Minimal Tx output power that can be used by the node
 */
#define ATCBR915_MIN_TX_POWER                          TX_POWER_10

/*!
 * Maximal Tx output power that can be used by the node
 */
#define ATCBR915_MAX_TX_POWER                          TX_POWER_0

/*!
 * Default Tx output power used by the node
 */
#define ATCBR915_DEFAULT_TX_POWER                      TX_POWER_0

/*!
 * Default uplink dwell time configuration
 */
#define ATCBR915_DEFAULT_UPLINK_DWELL_TIME             1

/*!
 * Default downlink dwell time configuration
 */
#define ATCBR915_DEFAULT_DOWNLINK_DWELL_TIME           0

/*!
 * Default Max EIRP
 */
#define ATCBR915_DEFAULT_MAX_EIRP                      30.0f

/*!
 * Default antenna gain
 */
#define ATCBR915_DEFAULT_ANTENNA_GAIN                  2.15f

/*!
 * ADR Ack limit
 */
#define ATCBR915_ADR_ACK_LIMIT                         64
 ...
 */
#define ATCBR915_DUTY_CYCLE_ENABLED                    0
 ...
 * Receive delay 1
 */
//#define ATCBR915_RECEIVE_DELAY1                        1000
#define ATCBR915_RECEIVE_DELAY1                        5000

/*!
 * Receive delay 2
 */
//#define ATCBR915_RECEIVE_DELAY2                        2000
#define ATCBR915_RECEIVE_DELAY2                        6000

/*!
 * Join accept delay 1
 */
#define ATCBR915_JOIN_ACCEPT_DELAY1                    5000

/*!
 * Join accept delay 2
 */
#define ATCBR915_JOIN_ACCEPT_DELAY2                    6000

/*!
 * Maximum frame counter gap
 */
#define ATCBR915_MAX_FCNT_GAP                          16384
 ...
 */
#define ATCBR915_ACK_TIMEOUT_RND                       1000

/*!
 * Second reception window channel frequency definition.
 */
#define ATCBR915_RX_WND_2_FREQ                         923300000

/*!
 * Second reception window channel datarate definition.
 */
#define ATCBR915_RX_WND_2_DR                           DR_8
 ...
 * Beacon frequency
 */
#define ATCBR915_BEACON_CHANNEL_FREQ                   923300000

/*!
 * Beacon frequency channel stepwidth
 */
#define ATCBR915_BEACON_CHANNEL_STEPWIDTH              600000

/*!
 * Number of possible beacon channels
 */
#define ATCBR915_BEACON_NB_CHANNELS                    8

/*!
 * Payload size of a beacon frame
 */
#define ATCBR915_BEACON_SIZE                           19

/*!
 * Size of RFU 1 field
 */
#define ATCBR915_RFU1_SIZE                             3

/*!
 * Size of RFU 2 field
 */
#define ATCBR915_RFU2_SIZE                             1

/*!
 * Datarate of the beacon channel
 */
#define ATCBR915_BEACON_CHANNEL_DR                     DR_10

/*!
 * Bandwith of the beacon channel
 */
#define ATCBR915_BEACON_CHANNEL_BW                     2

/*!
 * Ping slot channel datarate
 */
#define ATCBR915_PING_SLOT_CHANNEL_DR                  DR_10

/*!
 * LoRaMac maximum number of bands
 */
#define ATCBR915_MAX_NB_BANDS                          1

/*!
 * Band 0 definition
 * { DutyCycle, TxMaxPower, LastJoinTxDoneTime, LastTxDoneTime, TimeOff }
 */
#define ATCBR915_BAND0                                 { 1, ATCBR915_MAX_TX_POWER, 0, 0, 0 } //  100.0 %

/*!
 * Defines the first channel for RX window 1 for US band
 */
#define ATCBR915_FIRST_RX1_CHANNEL                     ( (uint32_t) 923300000 )

/*!
 * Defines the last channel for RX window 1 for US band
 */
#define ATCBR915_LAST_RX1_CHANNEL                      ( (uint32_t) 927500000 )
//#define ATCBR915_LAST_RX1_CHANNEL                      ( (uint32_t) 926800000 )

/*!
 * Defines the step width of the channels for RX window 1
 */
#define ATCBR915_STEPWIDTH_RX1_CHANNEL                 ( (uint32_t) 600000 )
//#define ATCBR915_STEPWIDTH_RX1_CHANNEL                 ( (uint32_t) 500000 )

/*!
 * Data rates table definition
 */
//static const uint8_t DataratesATCBR915[]  = { 12, 11, 10, 9, 8, 7, 8, 0, 12, 11, 10, 9, 8, 7, 0, 0 };
static const uint8_t DataratesATCBR915[]  = { 8, 8, 10, 9, 8, 7, 8, 0, 8, 8, 10, 9, 8, 7, 0, 0 };
//static const uint8_t DataratesATCBR915[]  = { 10, 10 };


/*!
 * Bandwidths table definition in Hz
 */
//static const uint32_t BandwidthsATCBR915[] = { 125000, 125000, 125000, 125000, 125000, 125000, 500000, 0, 500000, 500000, 500000, 500000, 500000, 500000, 0, 0 };
static const uint32_t BandwidthsATCBR915[] = { 125000, 125000, 125000, 125000, 125000, 125000, 125000, 125000, 500000, 500000, 500000, 500000, 500000, 500000, 500000, 500000 };
//static const uint32_t BandwidthsATCBR915[] = { 125000, 500000 };

/*!
 * Up/Down link data rates offset definition
 */
static const int8_t DatarateOffsetsATCBR915[7][6] =
{
 ...
 */
static const uint8_t MaxPayloadOfDatarateDwell0ATCBR915[] = { 51, 51, 51, 115, 242, 242, 242, 0, 53, 129, 242, 242, 242, 242 };
 ...
 * repeater support.
 */
static const uint8_t MaxPayloadOfDatarateRepeaterDwell0ATCBR915[] = { 51, 51, 51, 115, 222, 222, 222, 0, 33, 109, 222, 222, 222, 222 };
 ...
 * repeater support.
 */
//static const uint8_t MaxPayloadOfDatarateRepeaterDwell1ATCBR915[] = { 0, 0, 11, 53, 125, 242, 242, 0, 33, 109, 222, 222, 222, 222 };
static const uint8_t MaxPayloadOfDatarateRepeaterDwell1ATCBR915[] = { 0, 0, 12, 53, 125, 242, 242, 0, 33, 109, 222, 222, 222, 222 };
...
/*! \} defgroup REGIONATCBR915 */

#endif // __REGION_ATCBR915_H__
